...
The `corsAllowedOrigins` parameter is fully under the control of the
configuration field. No pinning or escaping is done to the value. Here is an
example of how you can pin a host name and escape dots:
